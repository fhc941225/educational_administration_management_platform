...
<script type="text/javascript">
    ...
    //待选课操作按钮
    function fn() {
        location.href="${pageContext.request.contextPath}/stu_course_list"
    }
    ...
    function addOperFunction() {
        return [
            '<button id="btnDeleteCourse" class="btn btn-primary" type="button">退课</button>&nbsp;&nbsp;&nbsp;',
    ...
    window.operateEvents = {
        "click #btnDeleteCourse": function (e, value, row, index) {
            $.post(
