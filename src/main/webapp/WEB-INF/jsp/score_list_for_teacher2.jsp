    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="${pageContext.request.contextPath}/score_list_for_teacher"><i class="fa fa-qrcode"></i> 录入成绩</a>
                </li>
                <li>
...
<script type="text/javascript">
    ...
    $(function(){
        //初始化表格course_id,course_name,course_time,class_room
        $("#list_for_teacher").bootstrapTable({
            //列参数
            columns: [{ field: 'stu_number', title: "学生学号" }, { field: 'student.stu_name', title: "学生姓名" }, { field: 'grade', title: "成绩" },{
                title:'操作',
                align: 'center',
                valign: 'middle',
                ...
                formatter: function (value, row, index) {
                    return ['<div class="btn-group btn-group-sm" role="group">\n',
                        ...
                        '<button id="btn_update" type="button" class="btn btn-info">打分</button>\n',
            ...
            //请求地址
            url: '${pageContext.request.contextPath}/Stugrades',
            //请求方式
            method:'post',
